...
public class myGUIControls : MonoBehaviour
{
    ...
    /// <summary>
    /// Event handler for ComplexButton
    /// </summary>
    /// <param name="sender">reference to Sender obj</param>
    /// <param name="e">EventArgs</param>
    public delegate void ComplexButtonEventHandler(object sender, EventArgs e);

    /// <summary>
    /// Class encapsulating variables for implementing a complex button in Unity
    /// </summary>
    [System.Serializable]
    public class ComplexButton
    {
        ...
        /// <summary>
        /// Changes the text of the button to the input string
        /// </summary>
        /// <param name="textIn">New text for the button</param>
    ...
    public class SaveDialog
    {
        ...
        /// </summary>
        public enum eventType { Load, Save, Export };
        /// <summary>
        ...
        /// Event in this case is an enum which is either save or load
        /// </summary>
    ...
    /// <summary>
    /// Defines a class which creates a simple horizontal panel of buttons
    /// </summary>
    [System.Serializable]
    public class HorizontalButtonPanel
    {
        /// <summary>
        /// Dimensions of the control's surroundings
        /// </summary>
        ...
        {
            //Draw the rectangle surrounding the panel
            GUI.Box(new Rect(X, Y, xSpacing + ((buttonArrayCast.width + xSpacing) * buttonArray.Length),
                buttonArrayCast.height + (2* ySpacing)), "");

            //Draw all the buttons
            for (int i = 0; i < buttonArray.Length; i++)
            {
                if (
                GUI.Button(new Rect(X + buttonArrayCast.X + xSpacing + (i * (xSpacing + buttonArrayCast.width)),
                    Y + buttonArrayCast.Y + ySpacing,
                    buttonArrayCast.width, buttonArrayCast.height), buttonArray[i].text))
                    PanelButtonClicked(i, new EventArgs());
            }
